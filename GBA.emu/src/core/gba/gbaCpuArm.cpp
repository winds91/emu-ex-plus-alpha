...
#define ARM_PREFETCH_NEXT cpu.ARM_PREFETCH_NEXT()
#define cpuPrefetch cpu.cpuPrefetch
#define CPUSwitchMode(mode, saveState) cpu.switchMode(cpu.gba->mem.ioMem, mode, saveState)
#define CPUUpdateFlags() cpu.updateFlags(cpu.gba->mem.ioMem)
...
#define armUnknownInsn(opcode) armUnknownInsn(cpu, opcode, clockTicks)

#ifdef VBAM_ENABLE_DEBUGGER
static INSN_REGPARM void armBreakpoint(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks)
{
    reg[15].I -= 4;
    armNextPC -= 4;
...
#ifndef SETCOND_MULL
#define SETCOND_MULL \
	cpu.setNZFlagParam(reg[dest].I, reg[acc].I);
#endif
...
#define DEFINE_ALU_INSN_C(CODE1, CODE2, OP, MODECHANGE) \
  static INSN_REGPARM void arm##CODE1##0(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks) { ALU_INSN(ALU_INIT_C, VALUE_LSL_IMM_C, OP_##OP, MODECHANGE_##MODECHANGE, 0); } \
  static INSN_REGPARM void arm##CODE1##1(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks) { ALU_INSN(ALU_INIT_C, VALUE_LSL_REG_C, OP_##OP, MODECHANGE_##MODECHANGE, 1); } \
  static INSN_REGPARM void arm##CODE1##2(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks) { ALU_INSN(ALU_INIT_C, VALUE_LSR_IMM_C, OP_##OP, MODECHANGE_##MODECHANGE, 0); } \
  static INSN_REGPARM void arm##CODE1##3(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks) { ALU_INSN(ALU_INIT_C, VALUE_LSR_REG_C, OP_##OP, MODECHANGE_##MODECHANGE, 1); } \
  static INSN_REGPARM void arm##CODE1##4(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks) { ALU_INSN(ALU_INIT_C, VALUE_ASR_IMM_C, OP_##OP, MODECHANGE_##MODECHANGE, 0); } \
  static INSN_REGPARM void arm##CODE1##5(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks) { ALU_INSN(ALU_INIT_C, VALUE_ASR_REG_C, OP_##OP, MODECHANGE_##MODECHANGE, 1); } \
  static INSN_REGPARM void arm##CODE1##6(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks) { ALU_INSN(ALU_INIT_C, VALUE_ROR_IMM_C, OP_##OP, MODECHANGE_##MODECHANGE, 0); } \
  static INSN_REGPARM void arm##CODE1##7(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks) { ALU_INSN(ALU_INIT_C, VALUE_ROR_REG_C, OP_##OP, MODECHANGE_##MODECHANGE, 1); } \
  static INSN_REGPARM void arm##CODE2##0(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks) { ALU_INSN(ALU_INIT_C, VALUE_IMM_C,     OP_##OP, MODECHANGE_##MODECHANGE, 0); }
#define DEFINE_ALU_INSN_NC(CODE1, CODE2, OP, MODECHANGE) \
  static INSN_REGPARM void arm##CODE1##0(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks) { ALU_INSN(ALU_INIT_NC, VALUE_LSL_IMM_NC, OP_##OP, MODECHANGE_##MODECHANGE, 0); } \
  static INSN_REGPARM void arm##CODE1##1(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks) { ALU_INSN(ALU_INIT_NC, VALUE_LSL_REG_NC, OP_##OP, MODECHANGE_##MODECHANGE, 1); } \
  static INSN_REGPARM void arm##CODE1##2(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks) { ALU_INSN(ALU_INIT_NC, VALUE_LSR_IMM_NC, OP_##OP, MODECHANGE_##MODECHANGE, 0); } \
  static INSN_REGPARM void arm##CODE1##3(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks) { ALU_INSN(ALU_INIT_NC, VALUE_LSR_REG_NC, OP_##OP, MODECHANGE_##MODECHANGE, 1); } \
  static INSN_REGPARM void arm##CODE1##4(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks) { ALU_INSN(ALU_INIT_NC, VALUE_ASR_IMM_NC, OP_##OP, MODECHANGE_##MODECHANGE, 0); } \
  static INSN_REGPARM void arm##CODE1##5(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks) { ALU_INSN(ALU_INIT_NC, VALUE_ASR_REG_NC, OP_##OP, MODECHANGE_##MODECHANGE, 1); } \
  static INSN_REGPARM void arm##CODE1##6(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks) { ALU_INSN(ALU_INIT_NC, VALUE_ROR_IMM_NC, OP_##OP, MODECHANGE_##MODECHANGE, 0); } \
  static INSN_REGPARM void arm##CODE1##7(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks) { ALU_INSN(ALU_INIT_NC, VALUE_ROR_REG_NC, OP_##OP, MODECHANGE_##MODECHANGE, 1); } \
  static INSN_REGPARM void arm##CODE2##0(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks) { ALU_INSN(ALU_INIT_NC, VALUE_IMM_NC,     OP_##OP, MODECHANGE_##MODECHANGE, 0); }
...
// MUL Rd, Rm, Rs
static INSN_REGPARM void arm009(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks) { MUL_INSN(OP_MUL, SETCOND_NONE, 1); }
// MULS Rd, Rm, Rs
static INSN_REGPARM void arm019(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks) { MUL_INSN(OP_MUL, SETCOND_MUL, 1); }

// MLA Rd, Rm, Rs, Rn
static INSN_REGPARM void arm029(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks) { MUL_INSN(OP_MLA, SETCOND_NONE, 2); }
// MLAS Rd, Rm, Rs, Rn
static INSN_REGPARM void arm039(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks) { MUL_INSN(OP_MLA, SETCOND_MUL, 2); }

// UMULL RdLo, RdHi, Rn, Rs
static INSN_REGPARM void arm089(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks) { MUL_INSN(OP_UMULL, SETCOND_NONE, 2); }
// UMULLS RdLo, RdHi, Rn, Rs
static INSN_REGPARM void arm099(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks) { MUL_INSN(OP_UMULL, SETCOND_MULL, 2); }

// UMLAL RdLo, RdHi, Rn, Rs
static INSN_REGPARM void arm0A9(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks) { MUL_INSN(OP_UMLAL, SETCOND_NONE, 3); }
// UMLALS RdLo, RdHi, Rn, Rs
static INSN_REGPARM void arm0B9(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks) { MUL_INSN(OP_UMLAL, SETCOND_MULL, 3); }

// SMULL RdLo, RdHi, Rm, Rs
static INSN_REGPARM void arm0C9(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks) { MUL_INSN(OP_SMULL, SETCOND_NONE, 2); }
// SMULLS RdLo, RdHi, Rm, Rs
static INSN_REGPARM void arm0D9(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks) { MUL_INSN(OP_SMULL, SETCOND_MULL, 2); }

// SMLAL RdLo, RdHi, Rm, Rs
static INSN_REGPARM void arm0E9(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks) { MUL_INSN(OP_SMLAL, SETCOND_NONE, 3); }
// SMLALS RdLo, RdHi, Rm, Rs
static INSN_REGPARM void arm0F9(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks) { MUL_INSN(OP_SMLAL, SETCOND_MULL, 3); }

// Misc instructions //////////////////////////////////////////////////////

// SWP Rd, Rm, [Rn]
static INSN_REGPARM void arm109(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks)
{
...
// SWPB Rd, Rm, [Rn]
static INSN_REGPARM void arm149(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks)
{
    uint32_t address = reg[(opcode >> 16) & 15].I;
...
// MRS Rd, CPSR
static INSN_REGPARM void arm100(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks)
{
...
// MRS Rd, SPSR
static INSN_REGPARM void arm140(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks)
{
...
// MSR CPSR_fields, Rm
static INSN_REGPARM void arm120(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks)
{
...
// MSR SPSR_fields, Rm
static INSN_REGPARM void arm160(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks)
{
...
// MSR CPSR_fields, #
static INSN_REGPARM void arm320(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks)
{
...
// MSR SPSR_fields, #
static INSN_REGPARM void arm360(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks)
{
...
// BX Rm
static INSN_REGPARM void arm121(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks)
{
...
#define STR(CALC_OFFSET, CALC_ADDRESS, STORE_DATA, WRITEBACK1, WRITEBACK2, SIZE) \
    ...
    STORE_DATA;                                         \
    WRITEBACK2;                                         \
    clockTicks = 2 + dataTicksAccess##SIZE(cpu, address)     \
                   + codeTicksAccess32(armNextPC);
#define LDR(CALC_OFFSET, CALC_ADDRESS, LOAD_DATA, WRITEBACK, SIZE) \
    ...
    clockTicks += 3 + dataTicksAccess##SIZE(cpu, address)    \
                    + codeTicksAccess32(armNextPC);
...
// STRH Rd, [Rn], -Rm
static INSN_REGPARM void arm00B(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks) { STR_POSTDEC(OFFSET_REG, OP_STRH, 16); }
// STRH Rd, [Rn], #-offset
static INSN_REGPARM void arm04B(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks) { STR_POSTDEC(OFFSET_IMM8, OP_STRH, 16); }
// STRH Rd, [Rn], Rm
static INSN_REGPARM void arm08B(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks) { STR_POSTINC(OFFSET_REG, OP_STRH, 16); }
// STRH Rd, [Rn], #offset
static INSN_REGPARM void arm0CB(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks) { STR_POSTINC(OFFSET_IMM8, OP_STRH, 16); }
// STRH Rd, [Rn, -Rm]
static INSN_REGPARM void arm10B(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks) { STR_PREDEC(OFFSET_REG, OP_STRH, 16); }
// STRH Rd, [Rn, -Rm]!
static INSN_REGPARM void arm12B(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks) { STR_PREDEC_WB(OFFSET_REG, OP_STRH, 16); }
// STRH Rd, [Rn, -#offset]
static INSN_REGPARM void arm14B(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks) { STR_PREDEC(OFFSET_IMM8, OP_STRH, 16); }
// STRH Rd, [Rn, -#offset]!
static INSN_REGPARM void arm16B(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks) { STR_PREDEC_WB(OFFSET_IMM8, OP_STRH, 16); }
// STRH Rd, [Rn, Rm]
static INSN_REGPARM void arm18B(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks) { STR_PREINC(OFFSET_REG, OP_STRH, 16); }
// STRH Rd, [Rn, Rm]!
static INSN_REGPARM void arm1AB(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks) { STR_PREINC_WB(OFFSET_REG, OP_STRH, 16); }
// STRH Rd, [Rn, #offset]
static INSN_REGPARM void arm1CB(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks) { STR_PREINC(OFFSET_IMM8, OP_STRH, 16); }
// STRH Rd, [Rn, #offset]!
static INSN_REGPARM void arm1EB(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks) { STR_PREINC_WB(OFFSET_IMM8, OP_STRH, 16); }

// LDRH Rd, [Rn], -Rm
static INSN_REGPARM void arm01B(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks) { LDR_POSTDEC(OFFSET_REG, OP_LDRH, 16); }
// LDRH Rd, [Rn], #-offset
static INSN_REGPARM void arm05B(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks) { LDR_POSTDEC(OFFSET_IMM8, OP_LDRH, 16); }
// LDRH Rd, [Rn], Rm
static INSN_REGPARM void arm09B(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks) { LDR_POSTINC(OFFSET_REG, OP_LDRH, 16); }
// LDRH Rd, [Rn], #offset
static INSN_REGPARM void arm0DB(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks) { LDR_POSTINC(OFFSET_IMM8, OP_LDRH, 16); }
// LDRH Rd, [Rn, -Rm]
static INSN_REGPARM void arm11B(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks) { LDR_PREDEC(OFFSET_REG, OP_LDRH, 16); }
// LDRH Rd, [Rn, -Rm]!
static INSN_REGPARM void arm13B(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks) { LDR_PREDEC_WB(OFFSET_REG, OP_LDRH, 16); }
// LDRH Rd, [Rn, -#offset]
static INSN_REGPARM void arm15B(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks) { LDR_PREDEC(OFFSET_IMM8, OP_LDRH, 16); }
// LDRH Rd, [Rn, -#offset]!
static INSN_REGPARM void arm17B(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks) { LDR_PREDEC_WB(OFFSET_IMM8, OP_LDRH, 16); }
// LDRH Rd, [Rn, Rm]
static INSN_REGPARM void arm19B(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks) { LDR_PREINC(OFFSET_REG, OP_LDRH, 16); }
// LDRH Rd, [Rn, Rm]!
static INSN_REGPARM void arm1BB(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks) { LDR_PREINC_WB(OFFSET_REG, OP_LDRH, 16); }
// LDRH Rd, [Rn, #offset]
static INSN_REGPARM void arm1DB(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks) { LDR_PREINC(OFFSET_IMM8, OP_LDRH, 16); }
// LDRH Rd, [Rn, #offset]!
static INSN_REGPARM void arm1FB(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks) { LDR_PREINC_WB(OFFSET_IMM8, OP_LDRH, 16); }

// LDRSB Rd, [Rn], -Rm
static INSN_REGPARM void arm01D(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks) { LDR_POSTDEC(OFFSET_REG, OP_LDRSB, 16); }
// LDRSB Rd, [Rn], #-offset
static INSN_REGPARM void arm05D(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks) { LDR_POSTDEC(OFFSET_IMM8, OP_LDRSB, 16); }
// LDRSB Rd, [Rn], Rm
static INSN_REGPARM void arm09D(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks) { LDR_POSTINC(OFFSET_REG, OP_LDRSB, 16); }
// LDRSB Rd, [Rn], #offset
static INSN_REGPARM void arm0DD(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks) { LDR_POSTINC(OFFSET_IMM8, OP_LDRSB, 16); }
// LDRSB Rd, [Rn, -Rm]
static INSN_REGPARM void arm11D(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks) { LDR_PREDEC(OFFSET_REG, OP_LDRSB, 16); }
// LDRSB Rd, [Rn, -Rm]!
static INSN_REGPARM void arm13D(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks) { LDR_PREDEC_WB(OFFSET_REG, OP_LDRSB, 16); }
// LDRSB Rd, [Rn, -#offset]
static INSN_REGPARM void arm15D(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks) { LDR_PREDEC(OFFSET_IMM8, OP_LDRSB, 16); }
// LDRSB Rd, [Rn, -#offset]!
static INSN_REGPARM void arm17D(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks) { LDR_PREDEC_WB(OFFSET_IMM8, OP_LDRSB, 16); }
// LDRSB Rd, [Rn, Rm]
static INSN_REGPARM void arm19D(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks) { LDR_PREINC(OFFSET_REG, OP_LDRSB, 16); }
// LDRSB Rd, [Rn, Rm]!
static INSN_REGPARM void arm1BD(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks) { LDR_PREINC_WB(OFFSET_REG, OP_LDRSB, 16); }
// LDRSB Rd, [Rn, #offset]
static INSN_REGPARM void arm1DD(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks) { LDR_PREINC(OFFSET_IMM8, OP_LDRSB, 16); }
// LDRSB Rd, [Rn, #offset]!
static INSN_REGPARM void arm1FD(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks) { LDR_PREINC_WB(OFFSET_IMM8, OP_LDRSB, 16); }

// LDRSH Rd, [Rn], -Rm
static INSN_REGPARM void arm01F(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks) { LDR_POSTDEC(OFFSET_REG, OP_LDRSH, 16); }
// LDRSH Rd, [Rn], #-offset
static INSN_REGPARM void arm05F(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks) { LDR_POSTDEC(OFFSET_IMM8, OP_LDRSH, 16); }
// LDRSH Rd, [Rn], Rm
static INSN_REGPARM void arm09F(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks) { LDR_POSTINC(OFFSET_REG, OP_LDRSH, 16); }
// LDRSH Rd, [Rn], #offset
static INSN_REGPARM void arm0DF(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks) { LDR_POSTINC(OFFSET_IMM8, OP_LDRSH, 16); }
// LDRSH Rd, [Rn, -Rm]
static INSN_REGPARM void arm11F(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks) { LDR_PREDEC(OFFSET_REG, OP_LDRSH, 16); }
// LDRSH Rd, [Rn, -Rm]!
static INSN_REGPARM void arm13F(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks) { LDR_PREDEC_WB(OFFSET_REG, OP_LDRSH, 16); }
// LDRSH Rd, [Rn, -#offset]
static INSN_REGPARM void arm15F(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks) { LDR_PREDEC(OFFSET_IMM8, OP_LDRSH, 16); }
// LDRSH Rd, [Rn, -#offset]!
static INSN_REGPARM void arm17F(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks) { LDR_PREDEC_WB(OFFSET_IMM8, OP_LDRSH, 16); }
// LDRSH Rd, [Rn, Rm]
static INSN_REGPARM void arm19F(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks) { LDR_PREINC(OFFSET_REG, OP_LDRSH, 16); }
// LDRSH Rd, [Rn, Rm]!
static INSN_REGPARM void arm1BF(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks) { LDR_PREINC_WB(OFFSET_REG, OP_LDRSH, 16); }
// LDRSH Rd, [Rn, #offset]
static INSN_REGPARM void arm1DF(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks) { LDR_PREINC(OFFSET_IMM8, OP_LDRSH, 16); }
// LDRSH Rd, [Rn, #offset]!
static INSN_REGPARM void arm1FF(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks) { LDR_PREINC_WB(OFFSET_IMM8, OP_LDRSH, 16); }

#undef dataTicksAccess32
// STR[T] Rd, [Rn], -#
// Note: STR and STRT do the same thing on the GBA (likewise for LDR/LDRT etc)
static INSN_REGPARM void arm400(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks) { STR_POSTDEC(OFFSET_IMM, OP_STR, 32); }
// LDR[T] Rd, [Rn], -#
static INSN_REGPARM void arm410(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks) { LDR_POSTDEC(OFFSET_IMM, OP_LDR, 32); }
// STRB[T] Rd, [Rn], -#
static INSN_REGPARM void arm440(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks) { STR_POSTDEC(OFFSET_IMM, OP_STRB, 16); }
// LDRB[T] Rd, [Rn], -#
static INSN_REGPARM void arm450(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks) { LDR_POSTDEC(OFFSET_IMM, OP_LDRB, 16); }
// STR[T] Rd, [Rn], #
static INSN_REGPARM void arm480(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks) { STR_POSTINC(OFFSET_IMM, OP_STR, 32); }
// LDR Rd, [Rn], #
static INSN_REGPARM void arm490(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks) { LDR_POSTINC(OFFSET_IMM, OP_LDR, 32); }
// STRB[T] Rd, [Rn], #
static INSN_REGPARM void arm4C0(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks) { STR_POSTINC(OFFSET_IMM, OP_STRB, 16); }
// LDRB[T] Rd, [Rn], #
static INSN_REGPARM void arm4D0(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks) { LDR_POSTINC(OFFSET_IMM, OP_LDRB, 16); }
// STR Rd, [Rn, -#]
static INSN_REGPARM void arm500(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks) { STR_PREDEC(OFFSET_IMM, OP_STR, 32); }
// LDR Rd, [Rn, -#]
static INSN_REGPARM void arm510(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks) { LDR_PREDEC(OFFSET_IMM, OP_LDR, 32); }
// STR Rd, [Rn, -#]!
static INSN_REGPARM void arm520(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks) { STR_PREDEC_WB(OFFSET_IMM, OP_STR, 32); }
// LDR Rd, [Rn, -#]!
static INSN_REGPARM void arm530(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks) { LDR_PREDEC_WB(OFFSET_IMM, OP_LDR, 32); }
// STRB Rd, [Rn, -#]
static INSN_REGPARM void arm540(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks) { STR_PREDEC(OFFSET_IMM, OP_STRB, 16); }
// LDRB Rd, [Rn, -#]
static INSN_REGPARM void arm550(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks) { LDR_PREDEC(OFFSET_IMM, OP_LDRB, 16); }
// STRB Rd, [Rn, -#]!
static INSN_REGPARM void arm560(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks) { STR_PREDEC_WB(OFFSET_IMM, OP_STRB, 16); }
// LDRB Rd, [Rn, -#]!
static INSN_REGPARM void arm570(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks) { LDR_PREDEC_WB(OFFSET_IMM, OP_LDRB, 16); }
// STR Rd, [Rn, #]
static INSN_REGPARM void arm580(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks) { STR_PREINC(OFFSET_IMM, OP_STR, 32); }
// LDR Rd, [Rn, #]
static INSN_REGPARM void arm590(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks) { LDR_PREINC(OFFSET_IMM, OP_LDR, 32); }
// STR Rd, [Rn, #]!
static INSN_REGPARM void arm5A0(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks) { STR_PREINC_WB(OFFSET_IMM, OP_STR, 32); }
// LDR Rd, [Rn, #]!
static INSN_REGPARM void arm5B0(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks) { LDR_PREINC_WB(OFFSET_IMM, OP_LDR, 32); }
// STRB Rd, [Rn, #]
static INSN_REGPARM void arm5C0(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks) { STR_PREINC(OFFSET_IMM, OP_STRB, 16); }
// LDRB Rd, [Rn, #]
static INSN_REGPARM void arm5D0(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks) { LDR_PREINC(OFFSET_IMM, OP_LDRB, 16); }
// STRB Rd, [Rn, #]!
static INSN_REGPARM void arm5E0(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks) { STR_PREINC_WB(OFFSET_IMM, OP_STRB, 16); }
// LDRB Rd, [Rn, #]!
static INSN_REGPARM void arm5F0(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks) { LDR_PREINC_WB(OFFSET_IMM, OP_LDRB, 16); }

// STR[T] Rd, [Rn], -Rm, LSL #
static INSN_REGPARM void arm600(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks) { STR_POSTDEC(OFFSET_LSL, OP_STR, 32); }
// STR[T] Rd, [Rn], -Rm, LSR #
static INSN_REGPARM void arm602(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks) { STR_POSTDEC(OFFSET_LSR, OP_STR, 32); }
// STR[T] Rd, [Rn], -Rm, ASR #
static INSN_REGPARM void arm604(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks) { STR_POSTDEC(OFFSET_ASR, OP_STR, 32); }
// STR[T] Rd, [Rn], -Rm, ROR #
static INSN_REGPARM void arm606(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks) { STR_POSTDEC(OFFSET_ROR, OP_STR, 32); }
// LDR[T] Rd, [Rn], -Rm, LSL #
static INSN_REGPARM void arm610(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks) { LDR_POSTDEC(OFFSET_LSL, OP_LDR, 32); }
// LDR[T] Rd, [Rn], -Rm, LSR #
static INSN_REGPARM void arm612(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks) { LDR_POSTDEC(OFFSET_LSR, OP_LDR, 32); }
// LDR[T] Rd, [Rn], -Rm, ASR #
static INSN_REGPARM void arm614(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks) { LDR_POSTDEC(OFFSET_ASR, OP_LDR, 32); }
// LDR[T] Rd, [Rn], -Rm, ROR #
static INSN_REGPARM void arm616(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks) { LDR_POSTDEC(OFFSET_ROR, OP_LDR, 32); }
// STRB[T] Rd, [Rn], -Rm, LSL #
static INSN_REGPARM void arm640(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks) { STR_POSTDEC(OFFSET_LSL, OP_STRB, 16); }
// STRB[T] Rd, [Rn], -Rm, LSR #
static INSN_REGPARM void arm642(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks) { STR_POSTDEC(OFFSET_LSR, OP_STRB, 16); }
// STRB[T] Rd, [Rn], -Rm, ASR #
static INSN_REGPARM void arm644(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks) { STR_POSTDEC(OFFSET_ASR, OP_STRB, 16); }
// STRB[T] Rd, [Rn], -Rm, ROR #
static INSN_REGPARM void arm646(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks) { STR_POSTDEC(OFFSET_ROR, OP_STRB, 16); }
// LDRB[T] Rd, [Rn], -Rm, LSL #
static INSN_REGPARM void arm650(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks) { LDR_POSTDEC(OFFSET_LSL, OP_LDRB, 16); }
// LDRB[T] Rd, [Rn], -Rm, LSR #
static INSN_REGPARM void arm652(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks) { LDR_POSTDEC(OFFSET_LSR, OP_LDRB, 16); }
// LDRB[T] Rd, [Rn], -Rm, ASR #
static INSN_REGPARM void arm654(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks) { LDR_POSTDEC(OFFSET_ASR, OP_LDRB, 16); }
// LDRB Rd, [Rn], -Rm, ROR #
static INSN_REGPARM void arm656(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks) { LDR_POSTDEC(OFFSET_ROR, OP_LDRB, 16); }
// STR[T] Rd, [Rn], Rm, LSL #
static INSN_REGPARM void arm680(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks) { STR_POSTINC(OFFSET_LSL, OP_STR, 32); }
// STR[T] Rd, [Rn], Rm, LSR #
static INSN_REGPARM void arm682(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks) { STR_POSTINC(OFFSET_LSR, OP_STR, 32); }
// STR[T] Rd, [Rn], Rm, ASR #
static INSN_REGPARM void arm684(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks) { STR_POSTINC(OFFSET_ASR, OP_STR, 32); }
// STR[T] Rd, [Rn], Rm, ROR #
static INSN_REGPARM void arm686(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks) { STR_POSTINC(OFFSET_ROR, OP_STR, 32); }
// LDR[T] Rd, [Rn], Rm, LSL #
static INSN_REGPARM void arm690(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks) { LDR_POSTINC(OFFSET_LSL, OP_LDR, 32); }
// LDR[T] Rd, [Rn], Rm, LSR #
static INSN_REGPARM void arm692(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks) { LDR_POSTINC(OFFSET_LSR, OP_LDR, 32); }
// LDR[T] Rd, [Rn], Rm, ASR #
static INSN_REGPARM void arm694(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks) { LDR_POSTINC(OFFSET_ASR, OP_LDR, 32); }
// LDR[T] Rd, [Rn], Rm, ROR #
static INSN_REGPARM void arm696(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks) { LDR_POSTINC(OFFSET_ROR, OP_LDR, 32); }
// STRB[T] Rd, [Rn], Rm, LSL #
static INSN_REGPARM void arm6C0(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks) { STR_POSTINC(OFFSET_LSL, OP_STRB, 16); }
// STRB[T] Rd, [Rn], Rm, LSR #
static INSN_REGPARM void arm6C2(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks) { STR_POSTINC(OFFSET_LSR, OP_STRB, 16); }
// STRB[T] Rd, [Rn], Rm, ASR #
static INSN_REGPARM void arm6C4(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks) { STR_POSTINC(OFFSET_ASR, OP_STRB, 16); }
// STRB[T] Rd, [Rn], Rm, ROR #
static INSN_REGPARM void arm6C6(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks) { STR_POSTINC(OFFSET_ROR, OP_STRB, 16); }
// LDRB[T] Rd, [Rn], Rm, LSL #
static INSN_REGPARM void arm6D0(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks) { LDR_POSTINC(OFFSET_LSL, OP_LDRB, 16); }
// LDRB[T] Rd, [Rn], Rm, LSR #
static INSN_REGPARM void arm6D2(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks) { LDR_POSTINC(OFFSET_LSR, OP_LDRB, 16); }
// LDRB[T] Rd, [Rn], Rm, ASR #
static INSN_REGPARM void arm6D4(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks) { LDR_POSTINC(OFFSET_ASR, OP_LDRB, 16); }
// LDRB[T] Rd, [Rn], Rm, ROR #
static INSN_REGPARM void arm6D6(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks) { LDR_POSTINC(OFFSET_ROR, OP_LDRB, 16); }
// STR Rd, [Rn, -Rm, LSL #]
static INSN_REGPARM void arm700(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks) { STR_PREDEC(OFFSET_LSL, OP_STR, 32); }
// STR Rd, [Rn, -Rm, LSR #]
static INSN_REGPARM void arm702(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks) { STR_PREDEC(OFFSET_LSR, OP_STR, 32); }
// STR Rd, [Rn, -Rm, ASR #]
static INSN_REGPARM void arm704(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks) { STR_PREDEC(OFFSET_ASR, OP_STR, 32); }
// STR Rd, [Rn, -Rm, ROR #]
static INSN_REGPARM void arm706(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks) { STR_PREDEC(OFFSET_ROR, OP_STR, 32); }
// LDR Rd, [Rn, -Rm, LSL #]
static INSN_REGPARM void arm710(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks) { LDR_PREDEC(OFFSET_LSL, OP_LDR, 32); }
// LDR Rd, [Rn, -Rm, LSR #]
static INSN_REGPARM void arm712(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks) { LDR_PREDEC(OFFSET_LSR, OP_LDR, 32); }
// LDR Rd, [Rn, -Rm, ASR #]
static INSN_REGPARM void arm714(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks) { LDR_PREDEC(OFFSET_ASR, OP_LDR, 32); }
// LDR Rd, [Rn, -Rm, ROR #]
static INSN_REGPARM void arm716(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks) { LDR_PREDEC(OFFSET_ROR, OP_LDR, 32); }
// STR Rd, [Rn, -Rm, LSL #]!
static INSN_REGPARM void arm720(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks) { STR_PREDEC_WB(OFFSET_LSL, OP_STR, 32); }
// STR Rd, [Rn, -Rm, LSR #]!
static INSN_REGPARM void arm722(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks) { STR_PREDEC_WB(OFFSET_LSR, OP_STR, 32); }
// STR Rd, [Rn, -Rm, ASR #]!
static INSN_REGPARM void arm724(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks) { STR_PREDEC_WB(OFFSET_ASR, OP_STR, 32); }
// STR Rd, [Rn, -Rm, ROR #]!
static INSN_REGPARM void arm726(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks) { STR_PREDEC_WB(OFFSET_ROR, OP_STR, 32); }
// LDR Rd, [Rn, -Rm, LSL #]!
static INSN_REGPARM void arm730(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks) { LDR_PREDEC_WB(OFFSET_LSL, OP_LDR, 32); }
// LDR Rd, [Rn, -Rm, LSR #]!
static INSN_REGPARM void arm732(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks) { LDR_PREDEC_WB(OFFSET_LSR, OP_LDR, 32); }
// LDR Rd, [Rn, -Rm, ASR #]!
static INSN_REGPARM void arm734(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks) { LDR_PREDEC_WB(OFFSET_ASR, OP_LDR, 32); }
// LDR Rd, [Rn, -Rm, ROR #]!
static INSN_REGPARM void arm736(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks) { LDR_PREDEC_WB(OFFSET_ROR, OP_LDR, 32); }
// STRB Rd, [Rn, -Rm, LSL #]
static INSN_REGPARM void arm740(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks) { STR_PREDEC(OFFSET_LSL, OP_STRB, 16); }
// STRB Rd, [Rn, -Rm, LSR #]
static INSN_REGPARM void arm742(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks) { STR_PREDEC(OFFSET_LSR, OP_STRB, 16); }
// STRB Rd, [Rn, -Rm, ASR #]
static INSN_REGPARM void arm744(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks) { STR_PREDEC(OFFSET_ASR, OP_STRB, 16); }
// STRB Rd, [Rn, -Rm, ROR #]
static INSN_REGPARM void arm746(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks) { STR_PREDEC(OFFSET_ROR, OP_STRB, 16); }
// LDRB Rd, [Rn, -Rm, LSL #]
static INSN_REGPARM void arm750(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks) { LDR_PREDEC(OFFSET_LSL, OP_LDRB, 16); }
// LDRB Rd, [Rn, -Rm, LSR #]
static INSN_REGPARM void arm752(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks) { LDR_PREDEC(OFFSET_LSR, OP_LDRB, 16); }
// LDRB Rd, [Rn, -Rm, ASR #]
static INSN_REGPARM void arm754(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks) { LDR_PREDEC(OFFSET_ASR, OP_LDRB, 16); }
// LDRB Rd, [Rn, -Rm, ROR #]
static INSN_REGPARM void arm756(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks) { LDR_PREDEC(OFFSET_ROR, OP_LDRB, 16); }
// STRB Rd, [Rn, -Rm, LSL #]!
static INSN_REGPARM void arm760(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks) { STR_PREDEC_WB(OFFSET_LSL, OP_STRB, 16); }
// STRB Rd, [Rn, -Rm, LSR #]!
static INSN_REGPARM void arm762(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks) { STR_PREDEC_WB(OFFSET_LSR, OP_STRB, 16); }
// STRB Rd, [Rn, -Rm, ASR #]!
static INSN_REGPARM void arm764(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks) { STR_PREDEC_WB(OFFSET_ASR, OP_STRB, 16); }
// STRB Rd, [Rn, -Rm, ROR #]!
static INSN_REGPARM void arm766(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks) { STR_PREDEC_WB(OFFSET_ROR, OP_STRB, 16); }
// LDRB Rd, [Rn, -Rm, LSL #]!
static INSN_REGPARM void arm770(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks) { LDR_PREDEC_WB(OFFSET_LSL, OP_LDRB, 16); }
// LDRB Rd, [Rn, -Rm, LSR #]!
static INSN_REGPARM void arm772(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks) { LDR_PREDEC_WB(OFFSET_LSR, OP_LDRB, 16); }
// LDRB Rd, [Rn, -Rm, ASR #]!
static INSN_REGPARM void arm774(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks) { LDR_PREDEC_WB(OFFSET_ASR, OP_LDRB, 16); }
// LDRB Rd, [Rn, -Rm, ROR #]!
static INSN_REGPARM void arm776(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks) { LDR_PREDEC_WB(OFFSET_ROR, OP_LDRB, 16); }
// STR Rd, [Rn, Rm, LSL #]
static INSN_REGPARM void arm780(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks) { STR_PREINC(OFFSET_LSL, OP_STR, 32); }
// STR Rd, [Rn, Rm, LSR #]
static INSN_REGPARM void arm782(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks) { STR_PREINC(OFFSET_LSR, OP_STR, 32); }
// STR Rd, [Rn, Rm, ASR #]
static INSN_REGPARM void arm784(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks) { STR_PREINC(OFFSET_ASR, OP_STR, 32); }
// STR Rd, [Rn, Rm, ROR #]
static INSN_REGPARM void arm786(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks) { STR_PREINC(OFFSET_ROR, OP_STR, 32); }
// LDR Rd, [Rn, Rm, LSL #]
static INSN_REGPARM void arm790(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks) { LDR_PREINC(OFFSET_LSL, OP_LDR, 32); }
// LDR Rd, [Rn, Rm, LSR #]
static INSN_REGPARM void arm792(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks) { LDR_PREINC(OFFSET_LSR, OP_LDR, 32); }
// LDR Rd, [Rn, Rm, ASR #]
static INSN_REGPARM void arm794(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks) { LDR_PREINC(OFFSET_ASR, OP_LDR, 32); }
// LDR Rd, [Rn, Rm, ROR #]
static INSN_REGPARM void arm796(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks) { LDR_PREINC(OFFSET_ROR, OP_LDR, 32); }
// STR Rd, [Rn, Rm, LSL #]!
static INSN_REGPARM void arm7A0(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks) { STR_PREINC_WB(OFFSET_LSL, OP_STR, 32); }
// STR Rd, [Rn, Rm, LSR #]!
static INSN_REGPARM void arm7A2(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks) { STR_PREINC_WB(OFFSET_LSR, OP_STR, 32); }
// STR Rd, [Rn, Rm, ASR #]!
static INSN_REGPARM void arm7A4(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks) { STR_PREINC_WB(OFFSET_ASR, OP_STR, 32); }
// STR Rd, [Rn, Rm, ROR #]!
static INSN_REGPARM void arm7A6(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks) { STR_PREINC_WB(OFFSET_ROR, OP_STR, 32); }
// LDR Rd, [Rn, Rm, LSL #]!
static INSN_REGPARM void arm7B0(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks) { LDR_PREINC_WB(OFFSET_LSL, OP_LDR, 32); }
// LDR Rd, [Rn, Rm, LSR #]!
static INSN_REGPARM void arm7B2(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks) { LDR_PREINC_WB(OFFSET_LSR, OP_LDR, 32); }
// LDR Rd, [Rn, Rm, ASR #]!
static INSN_REGPARM void arm7B4(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks) { LDR_PREINC_WB(OFFSET_ASR, OP_LDR, 32); }
// LDR Rd, [Rn, Rm, ROR #]!
static INSN_REGPARM void arm7B6(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks) { LDR_PREINC_WB(OFFSET_ROR, OP_LDR, 32); }
// STRB Rd, [Rn, Rm, LSL #]
static INSN_REGPARM void arm7C0(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks) { STR_PREINC(OFFSET_LSL, OP_STRB, 16); }
// STRB Rd, [Rn, Rm, LSR #]
static INSN_REGPARM void arm7C2(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks) { STR_PREINC(OFFSET_LSR, OP_STRB, 16); }
// STRB Rd, [Rn, Rm, ASR #]
static INSN_REGPARM void arm7C4(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks) { STR_PREINC(OFFSET_ASR, OP_STRB, 16); }
// STRB Rd, [Rn, Rm, ROR #]
static INSN_REGPARM void arm7C6(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks) { STR_PREINC(OFFSET_ROR, OP_STRB, 16); }
// LDRB Rd, [Rn, Rm, LSL #]
static INSN_REGPARM void arm7D0(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks) { LDR_PREINC(OFFSET_LSL, OP_LDRB, 16); }
// LDRB Rd, [Rn, Rm, LSR #]
static INSN_REGPARM void arm7D2(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks) { LDR_PREINC(OFFSET_LSR, OP_LDRB, 16); }
// LDRB Rd, [Rn, Rm, ASR #]
static INSN_REGPARM void arm7D4(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks) { LDR_PREINC(OFFSET_ASR, OP_LDRB, 16); }
// LDRB Rd, [Rn, Rm, ROR #]
static INSN_REGPARM void arm7D6(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks) { LDR_PREINC(OFFSET_ROR, OP_LDRB, 16); }
// STRB Rd, [Rn, Rm, LSL #]!
static INSN_REGPARM void arm7E0(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks) { STR_PREINC_WB(OFFSET_LSL, OP_STRB, 16); }
// STRB Rd, [Rn, Rm, LSR #]!
static INSN_REGPARM void arm7E2(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks) { STR_PREINC_WB(OFFSET_LSR, OP_STRB, 16); }
// STRB Rd, [Rn, Rm, ASR #]!
static INSN_REGPARM void arm7E4(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks) { STR_PREINC_WB(OFFSET_ASR, OP_STRB, 16); }
// STRB Rd, [Rn, Rm, ROR #]!
static INSN_REGPARM void arm7E6(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks) { STR_PREINC_WB(OFFSET_ROR, OP_STRB, 16); }
// LDRB Rd, [Rn, Rm, LSL #]!
static INSN_REGPARM void arm7F0(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks) { LDR_PREINC_WB(OFFSET_LSL, OP_LDRB, 16); }
// LDRB Rd, [Rn, Rm, LSR #]!
static INSN_REGPARM void arm7F2(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks) { LDR_PREINC_WB(OFFSET_LSR, OP_LDRB, 16); }
// LDRB Rd, [Rn, Rm, ASR #]!
static INSN_REGPARM void arm7F4(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks) { LDR_PREINC_WB(OFFSET_ASR, OP_LDRB, 16); }
// LDRB Rd, [Rn, Rm, ROR #]!
static INSN_REGPARM void arm7F6(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks) { LDR_PREINC_WB(OFFSET_ROR, OP_LDRB, 16); }
#define dataTicksAccess32(address) dataTicksAccess32(cpu, address)
...
// STMDA Rn, {Rlist}
static INSN_REGPARM void arm800(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks)
{
    if (busPrefetchCount == 0)
        busPrefetch = busPrefetchEnable;
...
// LDMDA Rn, {Rlist}
static INSN_REGPARM void arm810(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks)
{
    if (busPrefetchCount == 0)
        busPrefetch = busPrefetchEnable;
    int base = (opcode & 0x000F0000) >> 16;
...
// STMDA Rn!, {Rlist}
static INSN_REGPARM void arm820(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks)
{
    if (busPrefetchCount == 0)
        busPrefetch = busPrefetchEnable;
    int base = (opcode & 0x000F0000) >> 16;
...
// LDMDA Rn!, {Rlist}
static INSN_REGPARM void arm830(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks)
{
    if (busPrefetchCount == 0)
        busPrefetch = busPrefetchEnable;
    int base = (opcode & 0x000F0000) >> 16;
...
// STMDA Rn, {Rlist}^
static INSN_REGPARM void arm840(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks)
{
    if (busPrefetchCount == 0)
        busPrefetch = busPrefetchEnable;
    int base = (opcode & 0x000F0000) >> 16;
...
// LDMDA Rn, {Rlist}^
static INSN_REGPARM void arm850(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks)
{
    if (busPrefetchCount == 0)
        busPrefetch = busPrefetchEnable;
    int base = (opcode & 0x000F0000) >> 16;
...
// STMDA Rn!, {Rlist}^
static INSN_REGPARM void arm860(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks)
{
    if (busPrefetchCount == 0)
        busPrefetch = busPrefetchEnable;
    int base = (opcode & 0x000F0000) >> 16;
...
// LDMDA Rn!, {Rlist}^
static INSN_REGPARM void arm870(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks)
{
    if (busPrefetchCount == 0)
        busPrefetch = busPrefetchEnable;
    int base = (opcode & 0x000F0000) >> 16;
...
// STMIA Rn, {Rlist}
static INSN_REGPARM void arm880(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks)
{
    if (busPrefetchCount == 0)
        busPrefetch = busPrefetchEnable;
    int base = (opcode & 0x000F0000) >> 16;
...
// LDMIA Rn, {Rlist}
static INSN_REGPARM void arm890(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks)
{
    if (busPrefetchCount == 0)
        busPrefetch = busPrefetchEnable;
    int base = (opcode & 0x000F0000) >> 16;
...
// STMIA Rn!, {Rlist}
static INSN_REGPARM void arm8A0(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks)
{
    if (busPrefetchCount == 0)
        busPrefetch = busPrefetchEnable;
    int base = (opcode & 0x000F0000) >> 16;
...
// LDMIA Rn!, {Rlist}
static INSN_REGPARM void arm8B0(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks)
{
    if (busPrefetchCount == 0)
        busPrefetch = busPrefetchEnable;
    int base = (opcode & 0x000F0000) >> 16;
...
// STMIA Rn, {Rlist}^
static INSN_REGPARM void arm8C0(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks)
{
    if (busPrefetchCount == 0)
        busPrefetch = busPrefetchEnable;
    int base = (opcode & 0x000F0000) >> 16;
...
// LDMIA Rn, {Rlist}^
static INSN_REGPARM void arm8D0(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks)
{
    if (busPrefetchCount == 0)
        busPrefetch = busPrefetchEnable;
    int base = (opcode & 0x000F0000) >> 16;
...
// STMIA Rn!, {Rlist}^
static INSN_REGPARM void arm8E0(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks)
{
    if (busPrefetchCount == 0)
        busPrefetch = busPrefetchEnable;
    int base = (opcode & 0x000F0000) >> 16;
...
// LDMIA Rn!, {Rlist}^
static INSN_REGPARM void arm8F0(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks)
{
    if (busPrefetchCount == 0)
        busPrefetch = busPrefetchEnable;
    int base = (opcode & 0x000F0000) >> 16;
...
// STMDB Rn, {Rlist}
static INSN_REGPARM void arm900(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks)
{
    if (busPrefetchCount == 0)
        busPrefetch = busPrefetchEnable;
    int base = (opcode & 0x000F0000) >> 16;
...
// LDMDB Rn, {Rlist}
static INSN_REGPARM void arm910(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks)
{
    if (busPrefetchCount == 0)
        busPrefetch = busPrefetchEnable;
    int base = (opcode & 0x000F0000) >> 16;
...
// STMDB Rn!, {Rlist}
static INSN_REGPARM void arm920(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks)
{
    if (busPrefetchCount == 0)
        busPrefetch = busPrefetchEnable;
    int base = (opcode & 0x000F0000) >> 16;
...
// LDMDB Rn!, {Rlist}
static INSN_REGPARM void arm930(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks)
{
    if (busPrefetchCount == 0)
        busPrefetch = busPrefetchEnable;
    int base = (opcode & 0x000F0000) >> 16;
...
// STMDB Rn, {Rlist}^
static INSN_REGPARM void arm940(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks)
{
    if (busPrefetchCount == 0)
        busPrefetch = busPrefetchEnable;
    int base = (opcode & 0x000F0000) >> 16;
...
// LDMDB Rn, {Rlist}^
static INSN_REGPARM void arm950(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks)
{
    if (busPrefetchCount == 0)
        busPrefetch = busPrefetchEnable;
    int base = (opcode & 0x000F0000) >> 16;
...
// STMDB Rn!, {Rlist}^
static INSN_REGPARM void arm960(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks)
{
    if (busPrefetchCount == 0)
        busPrefetch = busPrefetchEnable;
    int base = (opcode & 0x000F0000) >> 16;
...
// LDMDB Rn!, {Rlist}^
static INSN_REGPARM void arm970(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks)
{
    if (busPrefetchCount == 0)
        busPrefetch = busPrefetchEnable;
    int base = (opcode & 0x000F0000) >> 16;
...
// STMIB Rn, {Rlist}
static INSN_REGPARM void arm980(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks)
{
    if (busPrefetchCount == 0)
        busPrefetch = busPrefetchEnable;
    int base = (opcode & 0x000F0000) >> 16;
...
// LDMIB Rn, {Rlist}
static INSN_REGPARM void arm990(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks)
{
    if (busPrefetchCount == 0)
        busPrefetch = busPrefetchEnable;
    int base = (opcode & 0x000F0000) >> 16;
...
// STMIB Rn!, {Rlist}
static INSN_REGPARM void arm9A0(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks)
{
    if (busPrefetchCount == 0)
        busPrefetch = busPrefetchEnable;
    int base = (opcode & 0x000F0000) >> 16;
...
// LDMIB Rn!, {Rlist}
static INSN_REGPARM void arm9B0(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks)
{
    if (busPrefetchCount == 0)
        busPrefetch = busPrefetchEnable;
    int base = (opcode & 0x000F0000) >> 16;
...
// STMIB Rn, {Rlist}^
static INSN_REGPARM void arm9C0(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks)
{
    if (busPrefetchCount == 0)
        busPrefetch = busPrefetchEnable;
    int base = (opcode & 0x000F0000) >> 16;
...
// LDMIB Rn, {Rlist}^
static INSN_REGPARM void arm9D0(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks)
{
    if (busPrefetchCount == 0)
        busPrefetch = busPrefetchEnable;
    int base = (opcode & 0x000F0000) >> 16;
...
// STMIB Rn!, {Rlist}^
static INSN_REGPARM void arm9E0(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks)
{
    if (busPrefetchCount == 0)
        busPrefetch = busPrefetchEnable;
    int base = (opcode & 0x000F0000) >> 16;
...
// LDMIB Rn!, {Rlist}^
static INSN_REGPARM void arm9F0(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks)
{
    if (busPrefetchCount == 0)
        busPrefetch = busPrefetchEnable;
    int base = (opcode & 0x000F0000) >> 16;
...
// B <offset>
static INSN_REGPARM void armA00(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks)
{
...
// BL <offset>
static INSN_REGPARM void armB00(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks)
{
	  int32_t offset = ((int32_t)(opcode & 0x00FFFFFF) << 8) >> 6;
    reg[14].I = reg[15].I - 4;
    reg[15].I += offset;
...
#ifdef GP_SUPPORT
// MRC
static INSN_REGPARM void armE01(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks)
{
}
#else
...
typedef INSN_REGPARM void (*insnfunc_t)(ARM7TDMI &cpu, uint32_t opcode, int &clockTicks);
#define REP16(insn)                                 \
...
#endif
constexpr insnfunc_t armInsnTable[4096] = {
...
int armExecute(ARM7TDMI &cpu)
{
    ...
    do {
        ...
        uint32_t opcode = cpu.prefetchArmOpcode();
        ...
        if (cond_res)
        	(*armInsnTable[((opcode >> 16) & 0xFF0) | ((opcode >> 4) & 0x0F)])(cpu, opcode, clockTicks);
#ifdef INSN_COUNTER
