...
inline void callJNIMethod(JNIEnv *env, jmethodID method, jobject obj, auto &&...args)
{
	env->CallVoidMethod(obj, method, IG_forward(args)...);
}

template<std::same_as<jobject> R>
inline jobject callJNIMethod(JNIEnv *env, jmethodID method, jobject obj, auto &&...args)
{
	return env->CallObjectMethod(obj, method, IG_forward(args)...);
}

template<std::same_as<jstring> R>
inline jstring callJNIMethod(JNIEnv *env, jmethodID method, jobject obj, auto &&...args)
{
	return (jstring)env->CallObjectMethod(obj, method, IG_forward(args)...);
}

template<std::same_as<jboolean> R>
inline jboolean callJNIMethod(JNIEnv *env, jmethodID method, jobject obj, auto &&...args)
{
	return env->CallBooleanMethod(obj, method, IG_forward(args)...);
}

template<std::same_as<jbyte> R>
inline jbyte callJNIMethod(JNIEnv *env, jmethodID method, jobject obj, auto &&...args)
{
	return env->CallByteMethod(obj, method, IG_forward(args)...);
}

template<std::same_as<jchar> R>
inline jchar callJNIMethod(JNIEnv *env, jmethodID method, jobject obj, auto &&...args)
{
	return env->CallCharMethod(obj, method, IG_forward(args)...);
}

template<std::same_as<jshort> R>
inline jshort callJNIMethod(JNIEnv *env, jmethodID method, jobject obj, auto &&...args)
{
	return env->CallShortMethod(obj, method, IG_forward(args)...);
}

template<std::same_as<jint> R>
inline jint callJNIMethod(JNIEnv *env, jmethodID method, jobject obj, auto &&...args)
{
	return env->CallIntMethod(obj, method, IG_forward(args)...);
}

template<std::same_as<jlong> R>
inline jlong callJNIMethod(JNIEnv *env, jmethodID method, jobject obj, auto &&...args)
{
	return env->CallLongMethod(obj, method, IG_forward(args)...);
}

template<std::same_as<jfloat> R>
inline jfloat callJNIMethod(JNIEnv *env, jmethodID method, jobject obj, auto &&...args)
{
	return env->CallFloatMethod(obj, method, IG_forward(args)...);
}

template<std::same_as<jdouble> R>
inline jdouble callJNIMethod(JNIEnv *env, jmethodID method, jobject obj, auto &&...args)
{
	return env->CallDoubleMethod(obj, method, IG_forward(args)...);
}

template<std::same_as<void> R>
inline void callJNIStaticMethod(JNIEnv *env, jmethodID method, jclass cls, auto &&...args)
{
	env->CallStaticVoidMethod(cls, method, IG_forward(args)...);
}

template<std::same_as<jobject> R>
inline jobject callJNIStaticMethod(JNIEnv *env, jmethodID method, jclass cls, auto &&...args)
{
	return env->CallStaticObjectMethod(cls, method, IG_forward(args)...);
}

template<std::same_as<jstring> R>
inline jstring callJNIStaticMethod(JNIEnv *env, jmethodID method, jclass cls, auto &&...args)
{
	return (jstring)env->CallStaticObjectMethod(cls, method, IG_forward(args)...);
}

template<std::same_as<jboolean> R>
inline jboolean callJNIStaticMethod(JNIEnv *env, jmethodID method, jclass cls, auto &&...args)
{
	return env->CallStaticBooleanMethod(cls, method, IG_forward(args)...);
}

template<std::same_as<jbyte> R>
inline jbyte callJNIStaticMethod(JNIEnv *env, jmethodID method, jclass cls, auto &&...args)
{
	return env->CallStaticByteMethod(cls, method, IG_forward(args)...);
}

template<std::same_as<jchar> R>
inline jchar callJNIStaticMethod(JNIEnv *env, jmethodID method, jclass cls, auto &&...args)
{
	return env->CallStaticCharMethod(cls, method, IG_forward(args)...);
}

template<std::same_as<jshort> R>
inline jshort callJNIStaticMethod(JNIEnv *env, jmethodID method, jclass cls, auto &&...args)
{
	return env->CallStaticShortMethod(cls, method, IG_forward(args)...);
}

template<std::same_as<jint> R>
inline jint callJNIStaticMethod(JNIEnv *env, jmethodID method, jclass cls, auto &&...args)
{
	return env->CallStaticIntMethod(cls, method, IG_forward(args)...);
}

template<std::same_as<jlong> R>
inline jlong callJNIStaticMethod(JNIEnv *env, jmethodID method, jclass cls, auto &&...args)
{
	return env->CallStaticLongMethod(cls, method, IG_forward(args)...);
}

template<std::same_as<jfloat> R>
inline jfloat callJNIStaticMethod(JNIEnv *env, jmethodID method, jclass cls, auto &&...args)
{
	return env->CallStaticFloatMethod(cls, method, IG_forward(args)...);
}

template<std::same_as<jdouble> R>
inline jdouble callJNIStaticMethod(JNIEnv *env, jmethodID method, jclass cls, auto &&...args)
{
