...
vice_team_t core_team[] = {
    { "1999-2024", "Pottendo", "@b{Pottendo}" },
    { "2005-2024", "Marco van den Heuvel", "Marco van den Heuvel <blackystardust68@yahoo.com>" },
    { "2007-2024", "Fabrizio Gennari", "Fabrizio Gennari <fabrizio.ge@tiscalinet.it>" },
    { "2009-2024", "Groepaz", "Groepaz <groepaz@gmx.net>" },
    { "2009-2024", "Errol Smith", "Errol Smith <strobey@users.sourceforge.net>" },
    { "2009-2024", "Ingo Korb", "Ingo Korb <ingo@akana.de>" },
    { "2010-2024", "Olaf Seibert", "Olaf Seibert <rhialto@falu.nl>" },
    { "2011-2024", "Marcus Sutton", "Marcus Sutton <loggedoubt@gmail.com>" },
    { "2011-2024", "Kajtar Zsolt", "Kajtar Zsolt <soci@c64.rulez.org>" },
    { "2016-2024", "AreaScout", "AreaScout <areascout@gmx.at>" },
    { "2016-2024", "Bas Wassink", "Bas Wassink <b.wassink@ziggo.nl>" },
    { "2017-2024", "Michael C. Martin", "Michael C. Martin <mcmartin@gmail.com>" },
    { "2018-2024", "Christopher Phillips", "Christopher Phillips <shrydar@users.sourceforge.net>" },
    { "2019-2024", "David Hogan", "David Hogan <david.q.hogan@gmail.com>" },
    { "2020-2024", "Empathic Qubit", "Empathic Qubit <empathicqubit@entan.gl>" },
    { "2020-2024", "Roberto Muscedere", "Roberto Muscedere <cococommie@cogeco.ca>" },
    { "2021-2024", "June Tate-Gans", "June Tate-Gans <june@theonelab.com>" },
    { "2021-2024", "Pablo Roldan", "Pablo Roldan" },
    { NULL, NULL, NULL }
};
